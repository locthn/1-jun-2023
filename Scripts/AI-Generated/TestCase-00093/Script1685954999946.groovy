...
'step 1: Navigate to Page_resources-center_blog_automation-testing-types'

WebUI.navigateToUrl(GlobalVariable.application_domain + '/resources-center/blog/automation-testing-types')

'step 2: Add visual checkpoint at Page_resources-center_blog_automation-testing-types'
